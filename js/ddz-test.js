...
// game.setPlayerChair();
    ...
    game.showGame();
    // console.log(game);
    // player3.chupai([103,104,105,518,516,104,103,408,409,516,518,303,403,104,103]);
    player2.chupai([103,103,104,105,518,516,104,103,408,409,103,408,409,516,518,303,403,104,103]);
